...
export interface ApiCustomUserCustomUser extends Schema.CollectionType {
  ...
  attributes: {
    firstName: Attribute.String;
    lastName: Attribute.String;
    saved_workout: Attribute.Relation<
      'api::custom-user.custom-user',
      'oneToOne',
...
export interface ApiDeleteAccountRequestDeleteAccountRequest
  extends Schema.CollectionType {
...
export interface ApiExerciseExercise extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    exercise_category: Attribute.Relation<
      'api::exercise.exercise',
      'manyToOne',
...
export interface ApiExerciseCategoryExerciseCategory
  extends Schema.CollectionType {
...
export interface ApiSavedWorkoutSavedWorkout extends Schema.CollectionType {
